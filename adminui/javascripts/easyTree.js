    ...
    $.fn.EasyTree = function (options) {
        var defaults = {
            ...
            i18n: {
                ...
                editNull: '請選擇要編輯的項目',
                editMultiple: '一次只能編輯一項',
                addMultiple: '請選擇要新增的項目',
                collapseTip: '收合',
                expandTip: '展開',
                selectTip: '選擇',
                unselectTip: '取消選擇',
        ...
        var createInput = $('<div class="input-group"><input type="text" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-default btn-success confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-white cancel"></button> </span> </div> ');
        ...
        this.each(function () {
            ...
            // editable
            if (options.editable) {
                $(easyTree).find('.easy-tree-toolbar').append('<div class="edit"><button class="btn btn-default btn-sm btn-primary disabled"><span class="fa fa-pencil"></span></button></div> ');
                ...
                $(easyTree).find('.easy-tree-toolbar .remove > button').attr('title', options.i18n.deleteTip).click(function () {
                    ...
                    if (selected.length <= 0) {
                        ...
                        $(easyTree).find('.alert .alert-content').html(options.i18n.deleteConfirmation)
                            .append('<a style="margin-left: 10px;" class="btn btn-sm btn-danger confirm"></a>')
